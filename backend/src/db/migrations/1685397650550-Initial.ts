...
export class Initial1685397650550 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`shifts\` (\`id\` int NOT NULL AUTO_INCREMENT, \`date\` date NOT NULL, \`type\` varchar(10) NOT NULL, \`dayOfWeek\` varchar(25) NOT NULL, \`nurseId\` int NULL, \`scheduleId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
